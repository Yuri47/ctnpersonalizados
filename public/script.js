...
//     if (!executou && $(window).scrollTop() > $('#box').offset().top/1.1) {
//         console.log('EXEC')
//         $('#box').show()
//         executou = true;
...
document.addEventListener('aos:in:dispara_1', ({ detail }) => {
    ...
    if(!executou){
    // replaceWithPaths($('#svg_caneca'));
    // replaceWithPaths($('#svg_camisa'));
    // replaceWithPaths($('#svg_body'));
    // startSVGAnimation($('#svg_caneca'));
    // startSVGAnimation($('#svg_camisa'));
    // startSVGAnimation($('#svg_body'));
...
function startSVGAnimation(parentElement) {
    drawSVGPaths(parentElement, 3000, 2000, 50);
}
